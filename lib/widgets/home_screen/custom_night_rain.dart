...
class CustomNightRain extends StatefulWidget {
  const CustomNightRain({super.key});

  @override
  State<CustomNightRain> createState() => _CustomNightRainState();
}

class _CustomNightRainState extends State<CustomNightRain>
  ...
  Widget _buildFrontElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .nightRainAnimationFrontContent(context, _moveAnimations),
    ]);
  }
  ...
  Widget _buildBackElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .nightRainAnimationBackContent(context, _moveAnimations)
    ]);
  }
}
