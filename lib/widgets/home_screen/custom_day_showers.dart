...
class CustomDayShowers extends StatefulWidget {
  const CustomDayShowers({super.key});

  @override
  State<CustomDayShowers> createState() => _CustomDayShowersState();
}

class _CustomDayShowersState extends State<CustomDayShowers>
  ...
  void _initializeAnimation() {
    ...
    _cloudAnimation4 =
        Tween<double>(begin: 1.4, end: 1.5).animate(_cloudController);
  ...
  Widget _buildFrontElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .dayShowersAnimationFrontContent(context, _animations),
    ]);
  }
  ...
  Widget _buildBackElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .dayShowersAnimationBackContent(context, _animations)
    ]);
  }
}
