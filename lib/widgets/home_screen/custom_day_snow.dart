...
class CustomDaySnow extends StatefulWidget {
  const CustomDaySnow({super.key});

  @override
  State<CustomDaySnow> createState() => _CustomDaySnowState();
}

class _CustomDaySnowState extends State<CustomDaySnow>
  ...
  Widget _buildFrontElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .daySnowAnimationFrontContent(context, _animations),
    ]);
  }
  ...
  Widget _buildBackElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .daySnowAnimationBackContent(context, _animations)
    ]);
  }
}
