...
class CustomNightSnow extends StatefulWidget {
  const CustomNightSnow({super.key});

  @override
  State<CustomNightSnow> createState() => _CustomNightSnowState();
}

class _CustomNightSnowState extends State<CustomNightSnow>
  ...
  Widget _buildFrontElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .nightSnowAnimationFrontContent(context, _animations),
    ]);
  }
  ...
  Widget _buildBackElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .nightSnowAnimationBackContent(context, _animations)
    ]);
  }
}
