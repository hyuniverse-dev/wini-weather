...
class CustomNightShowers extends StatefulWidget {
  const CustomNightShowers({super.key});

  @override
  State<CustomNightShowers> createState() => _CustomNightShowersState();
}

class _CustomNightShowersState extends State<CustomNightShowers>
  ...
  Widget _buildFrontElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .nightShowersAnimationFrontContent(context, _moveAnimations),
    ]);
  }
  ...
  Widget _buildBackElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .nightShowersAnimationBackContent(context, _moveAnimations)
    ]);
  }
}
