...
class CustomDayBlizzard extends StatefulWidget {
  const CustomDayBlizzard({super.key});

  @override
  State<CustomDayBlizzard> createState() => _CustomDayBlizzardState();
}

class _CustomDayBlizzardState extends State<CustomDayBlizzard>
  ...
  Widget _buildFrontElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .dayBlizzardAnimationFrontContent(context, _animations),
    ]);
  }
  ...
  Widget _buildBackElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .dayBlizzardAnimationBackContent(context, _animations)
    ]);
  }
}
