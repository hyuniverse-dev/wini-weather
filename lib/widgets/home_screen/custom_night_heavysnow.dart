...
class CustomNightHeavysnow extends StatefulWidget {
  const CustomNightHeavysnow({super.key});

  @override
  State<CustomNightHeavysnow> createState() => _CustomNightHeavysnowState();
}

class _CustomNightHeavysnowState extends State<CustomNightHeavysnow>
  ...
  Widget _buildFrontElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .nightHeavySnowAnimationFrontContent(context, _animations),
    ]);
  }
  ...
  Widget _buildBackElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .nightHeavySnowAnimationBackContent(context, _animations)
    ]);
  }
}
