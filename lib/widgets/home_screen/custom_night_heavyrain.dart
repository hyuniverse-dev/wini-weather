...
class CustomNightHeavyrain extends StatefulWidget {
  const CustomNightHeavyrain({super.key});

  @override
  State<CustomNightHeavyrain> createState() => _CustomNightHeavyrainState();
}

class _CustomNightHeavyrainState extends State<CustomNightHeavyrain>
  ...
  void _initializeAnimation() {
    ...
    _cloudAnimation3 =
        Tween<double>(begin: 1.4, end: 2.0).animate(CurvedAnimation(
          parent: _cloudController,
          curve: Curves.easeOut,
        ));

    _cloudAnimation4 =
        Tween<double>(begin: 1.4, end: 2.0).animate(_cloudController);
  ...
  Widget _buildFrontElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .nightHeavyrainAnimationFrontContent(context, _moveAnimations),
    ]);
  }
  ...
  Widget _buildBackElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .nightHeavyrainAnimationBackContent(context, _moveAnimations)
    ]);
  }
}
