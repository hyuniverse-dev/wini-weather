...
class CustomDayHeavyrain extends StatefulWidget {
  const CustomDayHeavyrain({super.key});

  @override
  State<CustomDayHeavyrain> createState() => _CustomDayHeavyrainState();
}

class _CustomDayHeavyrainState extends State<CustomDayHeavyrain>
  ...
  Widget _buildFrontElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .dayHeavyrainAnimationFrontContent(context, _animations),
    ]);
  }
  ...
  Widget _buildBackElements(BuildContext context) {
    return Stack(children: [
      CustomAnimationContent()
          .dayHeavyrainAnimationBackContent(context, _animations)
    ]);
  }
}
